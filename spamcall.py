#Decompile BY NGUYỄN NGUYÊN KHANG [DEV]
#CARK ĐC LUÔN À 
#GHÊ ĐẤY TOOL CỦA KHANG ĐẸP CHAI MÀ DÁM CARK
import os
...
\033[38;5;9m A\033[38;5;5mD\033[38;5;11mM\033[38;5;27mI\033[38;5;47mN:\033[1;32m⠀HEAT TOOL
\033[1;37m FACEBOOK:\033[1;32m⠀Nguyễn Nguyên Khang
\033[1;32m=======================================================================
"""
for h in banner:
       sys.stdout.write(h)
...
def run(sdt,i):                  
  ...
  threading.submit(KILO,sdt)
  threading.submit(GAPO,sdt) 
  print("[ HEAT TOOL [SPAM CALL,SMS DELAY 1s THÀNH CÔNG]",)  
  for j in range(0, 5):
    # code trong vòng lặp
    print(f" HEAT - TOOL | TOOL SPAM CALL SMS \r",end="")
